...
This tutorial covers the Bayesian inference workflow in statistika: specifying priors, computing posteriors with conjugate models, sampling from arbitrary posteriors with MCMC, and assessing convergence.
