...
```typescript
import { glm, poisson } from '@diogoribeiro7/statistika';
...
```typescript
import { glm, binomial } from '@diogoribeiro7/statistika';
...
```typescript
import { glm, gaussian } from '@diogoribeiro7/statistika';
...
```typescript
import { huberRegression, ransacRegression } from '@diogoribeiro7/statistika';
...
```typescript
import { kFoldCV, mse } from '@diogoribeiro7/statistika';
import { linearRegression, polynomialRegression } from '@diogoribeiro7/statistika';
