...
This tutorial covers time series analysis in node_stats: exploratory data analysis, ARIMA modeling, GARCH volatility models, VAR multivariate models, and forecasting.
...
```typescript
import { autocorrelation } from 'node_stats';
...
```typescript
import { adfTest } from 'node_stats';
...
```typescript
import { difference } from 'node_stats';
...
```typescript
import { simpleMovingAverage, exponentialMovingAverage } from 'node_stats';
...
```typescript
import { autoArima } from 'node_stats';
...
```typescript
import { forecastWithIntervals } from 'node_stats';
...
```typescript
import { seasonalDecompose } from 'node_stats';
...
```typescript
import { garchFit, garchForecast } from 'node_stats/garch';
...
```typescript
import { egarchFit } from 'node_stats/garch';
...
```typescript
import { archLMTest } from 'node_stats/garch';
...
```typescript
import { varFit, varLagSelect } from 'node_stats/var';
...
```typescript
import { grangerCausality } from 'node_stats/var';
...
```typescript
import { impulseResponse, varianceDecomposition, varForecast } from 'node_stats/var';
...
```typescript
import { adfTest, autoArima, forecastWithIntervals, seasonalDecompose } from 'node_stats';
