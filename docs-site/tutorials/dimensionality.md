...
statistika provides a full suite of dimensionality reduction techniques (PCA, t-SNE, UMAP) and clustering algorithms (k-means, hierarchical, DBSCAN, GMM) along with cluster validation metrics.
