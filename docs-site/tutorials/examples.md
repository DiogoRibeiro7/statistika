...
```typescript
import { arima, autocorrelation, adfTest, difference } from '@diogoribeiro7/statistika';
...
```typescript
import { kaplanMeier, logRankTest } from '@diogoribeiro7/statistika';
...
```typescript
import { metropolisHastingsND, gelmanRubin, estimateESS } from '@diogoribeiro7/statistika';
