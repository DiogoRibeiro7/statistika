...
/** Result of an autocorrelation computation. */
 ...
 *
 * ACF is computed using the standard biased estimator.
 ...
 *
 * @param series - The time series data
 * @param alpha - Smoothing factor in (0, 1]. Higher = more weight on recent.
 */
...
/**
 * Weighted moving average (WMA) with linearly decreasing weights.
 *
 * @param series - The time series data
 ...
 * - AR coefficients are estimated via Yule-Walker equations.
